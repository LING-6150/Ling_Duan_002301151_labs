...
layout.next(userProcessContainer);
    ...
    private void btnCheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckOutActionPerformed
       ...
       populatecombo();
        ...
        JOptionPane.showMessageDialog(this, "Thank for your purchase. Looking forward to seeing you again!");
...
if (item == null) {
    ...
    int oldQuant = item.getQuantity();
    if (item.getProduct().getAvail() + oldQuant < quant) {
        JOptionPane.showMessageDialog(this, "Please check check product availability.");
        return;
    }
    item.getProduct().setAvail(item.getProduct().getAvail() + oldQuant - quant);
    item.setQuantity(quant);
